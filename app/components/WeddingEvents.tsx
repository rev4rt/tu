            ...
            <div className="mt-10">
              ...
              <div className="flex">
                <div className="w-[20%] bg-[#424242] rounded-bl-[1.25rem] flex items-center">
                  <p className="rotate-90 text-center text-white font-bold text-[1.20rem] -translate-x-5 lg:-translate-x-3.5 tracking-[5px]">
            ...
            <div className="mt-6">
              ...
              <div className="flex">
                ...
                <div className="w-[20%] bg-[#424242] rounded-br-[1.25rem] flex items-center">
                  <p className="-rotate-90 text-center text-white font-bold text-[1.20rem] -translate-x-[3rem] lg:-translate-x-[2.35rem] tracking-[5px]">
                    AKAD & RESEPSI
                  </p>
                </div>
              </div>
